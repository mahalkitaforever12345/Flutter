                ...
                child: Row(
                  ...
                  children: [
                    Icon(
                      ...
                      color: Color.fromARGB(255, 28, 100, 182),
                      size: 50,
                    ),
                    SizedBox(width: 30),  
                    Text(
                      ...
                      style: TextStyle(
                        color: Color.fromARGB(255, 70, 143, 252),
                        fontFamily: 'Arial',
                        fontSize: 20,
                  ...
                  Container(
                    ...
                    child: Center(
                      child: Icon(
                        ...
                        color: Color.fromARGB(255, 39, 132, 185),
                        size: 40,
                      ),
                    ),
                  ),
                  Container(
                    ...
                    child: Center(
                      child: Icon(
                        ...
                        color: Color.fromARGB(255, 25, 140, 218),
                        size: 40,
                      ),
                    ),
                  ),
                  Container(
                    ...
                    child: Center(
                      child: Icon(
                        ...
                        color: Color.fromARGB(255, 30, 117, 199),
                        size: 40,
                      ),
                    ),
                  ),
